package com.kh.myprj.domain.common.mail;
...
public class MailService {
  ...
  public void sendMail(String to, String subject, String body) {
     ...
     try {
        ...
        messageHelper.setFrom(from);			 //발신자
  ...
  public void sendMailWithAttach(String to, String subject, String body, List<File> files) {
    MimeMessage message = mailSender.createMimeMessage();
    ...
    try {
       ...
       if(files.size() > 0) {
      	 for(File file : files) {
      		 messageHelper.addAttachment("첨부파일", file);
      	 }
       }
       mailSender.send(message);					 //메일 발송
  ...
  public void sendMailWithInline(String to, String subject, String body, List<File> files) {
    MimeMessage message = mailSender.createMimeMessage();
