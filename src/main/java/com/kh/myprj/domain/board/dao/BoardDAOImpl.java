...
public class BoardDAOImpl implements BoardDAO {
	...
	public Long reply(BoardDTO boardDTO) {
		...
		//부모글의 bgroup 중 bstep이 부모글의 bstep보다 큰 게시글의 bstep + 1 
	...
	public List<BoardDTO> list() {
		...
		List<BoardDTO> list = jt.query(sql.toString(), new BeanPropertyRowMapper<>(BoardDTO.class));
	...
	public BoardDTO itemDetail(Long bnum) {
		...
		BoardDTO boardDTO = jt.queryForObject(sql.toString(), new BeanPropertyRowMapper<>(BoardDTO.class), bnum);
